...
#define K_CHASSIS_REMOTE_FORWARD		3500.0F//各控制值比例值 可根据实际情况调整
#define K_CHASSIS_REMOTE_RIGHT			3000.0F
#define K_CHASSIS_REMOTE_YAW_W			3000.0F
...
typedef struct{
	...
	float pitch_gyro;			
	float k_spd_all;						//各按键对应的比例系数
	
	float sup_s_cooling_time;		//超级电容控制板的返回值
	float sup_s_status;
