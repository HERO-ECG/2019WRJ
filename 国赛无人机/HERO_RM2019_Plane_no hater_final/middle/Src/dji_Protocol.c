...
/*--------------------- */
void CapacitanceStatesTransmit(uint8_t CapacitanceStates)
{
	float data1,data2,data3;
	u8 mask = 1;
	u16 tempcrc16;
	data1 = 521;//(float)allow17num;
	data2 = 520;
	data3 = 25.3614f;
	mask = CapacitanceStates;
	...
	FrameAllMessage[9] = 14;
	FrameAllMessage[10]= 14>>8;
	FrameAllMessage[11]= (unsigned char)0x0114;
	FrameAllMessage[12]= 0x0114>>8;
